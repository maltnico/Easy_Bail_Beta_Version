...
import { Menu, X, FileText, ChevronDown, Play, Star } from 'lucide-react';
            ...
            <div className="relative group">
              ...
              {isProductMenuOpen && (
                <div 
                  ...
                  onMouseLeave={() => setIsProductMenuOpen(false)}
                >
                  <a href="#fonctionnalites" className="block px-6 py-3 text-gray-700 hover:text-blue-600 hover:bg-blue-50 transition-colors">
                    <div className="font-medium">Fonctionnalités</div>
                    <div className="text-sm text-gray-500">Découvrez toutes nos fonctionnalités</div>
                  </a>
                  <a href="#" className="block px-6 py-3 text-gray-700 hover:text-blue-600 hover:bg-blue-50 transition-colors">
                    <div className="font-medium">Intégrations</div>
                    <div className="text-sm text-gray-500">Connectez vos outils favoris</div>
                  </a>
                  <a href="#" className="block px-6 py-3 text-gray-700 hover:text-blue-600 hover:bg-blue-50 transition-colors">
                    <div className="font-medium">API</div>
                    <div className="text-sm text-gray-500">Développez avec notre API</div>
                  </a>
                </div>
              )}
            </div>
            <a href="#tarifs" className="text-gray-700 hover:text-blue-600 transition-colors font-semibold">
              Tarifs
            </a>
            <a href="#" className="text-gray-700 hover:text-blue-600 transition-colors font-semibold">
              Ressources
            </a>
            <a href="#" className="text-gray-700 hover:text-blue-600 transition-colors font-semibold">
              Blog
            </a>
            <a href="#contact" className="text-gray-700 hover:text-blue-600 transition-colors font-semibold">
              Contact
            </a>
          </nav>
        ...
        {isMenuOpen && (
          <div className="md:hidden py-6 border-t border-gray-100 bg-white">
            <div className="flex flex-col space-y-4">
              <a href="#fonctionnalites" className="text-gray-700 hover:text-blue-600 transition-colors font-medium py-2">
                Fonctionnalités
              </a>
              <a href="#tarifs" className="text-gray-700 hover:text-blue-600 transition-colors font-medium py-2">
                Tarifs
              </a>
              ...
              <div className="flex flex-col space-y-3 pt-6 border-t border-gray-100">
                <button className="flex items-center text-gray-700 hover:text-blue-600 transition-colors font-medium py-2">
                  <Play className="h-4 w-4 mr-2" />
                  Voir la démo
                </button>
                <Link
                  to="/login"
                  className="text-gray-700 hover:text-blue-600 font-semibold transition-colors text-left py-2"
                >
                  Se connecter
                </Link>
                <Link
