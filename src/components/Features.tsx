  ...
  const features = [
    {
      ...
      features: [
        ...
        "Archivage sécurisé illimité"
      ]
    },
    {
      icon: Play,
      title: "Mise en location",
      description: "Processus guidé de A à Z pour vos nouvelles locations",
      color: "bg-green-600",
      features: [
        ...
        "Onboarding locataire personnalisé"
      ]
    },
    {
      icon: Zap,
      ...
      features: [
        ...
        "Suivi des échéances automatique"
      ]
    },
    {
      icon: TrendingUp,
